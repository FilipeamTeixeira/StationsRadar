...
dir.create(file.path("plotgtfs/VR_27_Aalst"))
dir.create(file.path("plotgtfs/VR_27_Aalst/dim"))
dir.create(file.path("plotgtfs/VR_27_Aalst/ind"))
    
    dimensions <- read_excel("csv/Rose_27stations_01212010_new.xlsx", 
    ...
    dimensions_df <- dimensions[3:29,] #Selection 27 stations
    ...
    for (i in 1:27){
      ...
      ggsave(paste("plotgtfs/VR_27_Aalst/dim/", name, "_", id, ".png", sep = ""),
             width = 8, height = 8)
    ...
    indicators <- read_excel("csv/Rose_27stations_01212010_new.xlsx",
    ...
    indicators_df <- indicators[4:30,] #Selection 23 stations
    ...
    for (i in 1:27){
      ...
      ggsave(paste("plotgtfs/VR_27_Aalst/ind/", name, "_", id, ".png", sep = ""),
             width = 7, height = 7)
      print(paste(name, "_", id, sep = ""))
    }
