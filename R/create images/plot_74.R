#plot Functionele regio Gent 74


indicators_df <- indicators[4:290,] #All stations

#get pictures for gtfs centrality
...
#Plot Dimensions ####
dir.create(file.path("plotgtfs/FR_74_Gent"))
dir.create(file.path("plotgtfs/FR_74_Gent/dim"))
dir.create(file.path("plotgtfs/FR_74_Gent/ind"))

dimensions <- read_excel("csv/Rose_74stations_12142018.xlsx", 
...
for (i in 1:74){
  ...
  ggsave(paste("plotgtfs/FR_74_Gent/dim/", name, "_", id, ".png", sep = ""),
         width = 8, height = 8)
...
indicators <- read_excel("csv/Rose_74stations_12142018.xlsx",
...
for (i in 1:74){
  ...
  ggsave(paste("plotgtfs/FR_74_Gent/ind/", name, "_", id, ".png", sep = ""),
         width = 7, height = 7)
  print(paste(name, "_", id, sep = ""))
}
