...
dir.create(file.path("plotgtfs/All"))
dir.create(file.path("plotgtfs/All/dim"))
dir.create(file.path("plotgtfs/All/ind"))

dimensions <- read_excel("csv/Rose_Allstations.xlsx", 
...
dimensions_df <- dimensions[3:289,]
...
for (i in 1:287){
  ...
  ggsave(paste("plotgtfs/All/dim/", name, "_", id, ".png", sep = ""),
         width = 8, height = 8)
...
indicators <- read_excel("csv/Rose_Allstations.xlsx",
...
indicators_df <- indicators[4:290,]
...
for (i in 1:287){
  ...
  ggsave(paste("plotgtfs/All/ind/", name, "_", id, ".png", sep = ""),
         width = 7, height = 7)
  print(paste(name, "_", id, sep = ""))
}
