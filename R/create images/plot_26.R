...
dir.create(file.path("plotgtfs/VR_26_Leuven"))
dir.create(file.path("plotgtfs/VR_26_Leuven/dim"))
dir.create(file.path("plotgtfs/VR_26_Leuven/ind"))
    
    dimensions <- read_excel("csv/Rose_26stations_16022019.xlsx", 
    ...
    dimensions_df <- dimensions[3:28,] #Selection 26 stations
    ...
    for (i in 1:26){
      ...
      ggsave(paste("plotgtfs/VR_26_Leuven/dim/", name, "_", id, ".png", sep = ""),
             width = 8, height = 8)
    ...
    indicators <- read_excel("csv/Rose_26stations_16022019.xlsx",
    ...
    indicators_df <- indicators[4:29,] #Selection 23 stations
    ...
    for (i in 1:26){
      ...
      ggsave(paste("plotgtfs/VR_26_Leuven/ind/", name, "_", id, ".png", sep = ""),
             width = 7, height = 7)
      print(paste(name, "_", id, sep = ""))
    }
